    ...
    <form action="/student/{{ $student->id }}" method="POST">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold text-gray-900">Update Student</h2>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    {{-- Current Photo --}}
                    <div class="sm:col-span-6">
                        <label class="block text-sm font-medium text-gray-900">Current Photo</label>
                        <div class="mt-2">
                            @if($student->photo)
                    ...
                    {{-- New Photo --}}
                    <div class="sm:col-span-6">
                        <label for="photo" class="block text-sm font-medium text-gray-900">Change Photo</label>
                        <div class="mt-2">
                            <input
                                id="photo"
                                type="file"
