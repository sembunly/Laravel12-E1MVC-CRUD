<x-layout ptitle="Employee Edit">
    <x-slot:header>
        <h1 class="text-2xl font-bold">Employee Edit</h1>
    </x-slot:header>
    ...
    <form action="/employee/{{ $employee->id }}" method="POST">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold text-gray-900">Edit Employee</h2>
    ...
    <form id="form-delete" action="/employee/{{ $employee->id }}" method="POST" class="hidden">
        @csrf
        @method('DELETE')
    </form>
</x-layout>