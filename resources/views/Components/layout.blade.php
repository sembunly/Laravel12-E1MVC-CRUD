  ...
  <nav class="bg-gray-800">
      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            @guest
              <x-nav-link href="login" active="request{{request()->is('login')}}"> Login</x-nav-link>
              <x-nav-link href="register" active="request{{request()->is('register')}}"> Register</x-nav-link>
            @endguest
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <a href="/home" aria-current="page" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Home</a>
